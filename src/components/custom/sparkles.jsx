  ...
  return (
    (<div
      ...
      <div className="w-[40rem] h-40 relative">
        ...
        <a href="/notifications"><Cover className="text-white text-3xl font-bold rounded-lg p-4 overflow-hidden h-full w-full border-slate-800 border-4">Notifications</Cover></a>
    </div>)
  );
}
